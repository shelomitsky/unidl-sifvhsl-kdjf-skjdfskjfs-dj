...
class ControllerExtensionDashboardUniRequest extends Controller {
	...
	public function dashboard() {
		...
		if ($this->config->get('uni_request') && $this->user->hasPermission('access', 'extension/module/uni_request') && $this->user->hasPermission('modify', 'extension/dashboard/uni_request')) {
