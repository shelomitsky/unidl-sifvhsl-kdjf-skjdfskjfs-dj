<?php
$_['text_heading_title'] = 'Рекомендуем';
$_['heading_product_category'] = 'Рекомендуемые по категориям';
$_['text_all_latest'] = 'Все рекомендуемые';
$_['text_deselect'] = 'Отменить выбор категории';
